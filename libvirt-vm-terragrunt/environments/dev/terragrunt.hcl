...
inputs = {
  ...
  vms_config   = {
    "host1-dev.company.com"  = { 
       vcpus = 1
       memory = 1024
       ipaddresses = ["192.168.101.10"]
       macaddress = "52:54:00:00:01:10"
       password = "ubuntu"
       }
    "fs1-dev.company.com"    = {
       vcpus = 1
       memory = 1024
       ipaddresses = ["192.168.101.11"]
       macaddress = "52:54:00:00:01:11"
       password = "ubuntu"
       }
    "web1-dev.company.com"   = {
       vcpus = 1
       memory = 1024
       ipaddresses = ["192.168.101.12"]
       macaddress = "52:54:00:00:01:12"
       password = "ubuntu"
       }
  }
