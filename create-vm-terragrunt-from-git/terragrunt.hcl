...
inputs = {
  ...
  vms_config   = {
    "alse183.astralinux.test"  = { vcpus = 2, memory = 4096, ipaddresses = ["192.168.105.10"], macaddress = "52:54:00:00:05:10", password = "password" }
    #"fs1-fromgit.astralinux.test"    = { vcpus = 1, memory = 1024, ipaddresses = ["192.168.105.11"], macaddress = "52:54:00:00:05:11", password = "password"  }
    # "web1-fromgit.astralinux.test"   = { vcpus = 1, memory = 1024, ipaddresses = ["192.168.105.12"], macaddress = "52:54:00:00:05:12", password = "password"  }
  }
